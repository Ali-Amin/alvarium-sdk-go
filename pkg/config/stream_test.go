...
func TestStreamInfoUnmarshal(t *testing.T) {
	...
	c, _ := json.Marshal(&fail)
	d, _ := json.Marshal(&fail2)
	e, _ := json.Marshal(&pass3)
	...
	tests := []struct {
		...
		{"valid StreamInfo type #3", e, false},
		{"invalid StreamInfo type", c, true},
		{"unhandled StreamInfo type", d, true},
	}
